...
# =========================================================================
# MUDANÇA 1: Atualização para o novo formato de modelo salvo (.keras)
# =========================================================================
model = tf.keras.models.load_model("modelo_mic_simulacao1.keras")
...
def prever(audio):
    ...
    # =========================================================================
    # MUDANÇA 2: Adequação para o shape do novo modelo (CNN + LSTM)
    # No treino, usamos expand_dims no final criando a estrutura (Frequencia, Tempo, 1).
    # Aqui adicionamos o Batch (eixo 0) e o canal de cor (eixo -1).
    # O shape final enviado será (1, Frequencia, Tempo, 1), exatamente como no treino.
    # =========================================================================
